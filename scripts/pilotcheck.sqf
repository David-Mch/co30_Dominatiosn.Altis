...
_pilots = ["B_pilot_F"];
_aircraft_nocopilot = ["B_Heli_Transport_03_unarmed_F","B_Heli_Transport_03_F","B_Heli_Light_01_F","B_Heli_Transport_01_camo_F", "B_Heli_Transport_01_F", "I_Heli_Transport_02_F","C_IDAP_Heli_Transport_02_F","O_Heli_Light_02_F", "O_Heli_Light_02_unarmed_F", "B_Heli_Light_01_armed_F"];
