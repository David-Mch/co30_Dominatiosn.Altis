...
d_sm_array =
	[
		1,2,3,4,5,6,7, //arrest an officer
...
if (call d_fnc_checkSHC) then {		
	...
	d_sm_convoy_vehicles = switch (d_enemy_side_short) do {
		case "E": {["O_MRAP_02_hmg_F","O_MBT_02_cannon_F", "O_MRAP_02_hmg_F", "O_Truck_03_repair_F", "O_Truck_03_fuel_F", "O_Truck_03_ammo_F", "O_MBT_02_cannon_F"]};
		...
		case "G": {["I_MRAP_03_hmg_F","I_APC_tracked_03_cannon_F", "I_MBT_03_cannon_F", "I_Truck_02_box_F", "I_Truck_02_fuel_F", "I_Truck_02_ammo_F", "I_APC_tracked_03_cannon_F"]};
	};
#endif
#ifdef __CUP_CHERNARUS__
	d_sm_convoy_vehicles = switch (d_enemy_side_short) do {
	...
	if (!d_tt_tanoa) then {
		d_sm_convoy_vehicles = switch (d_enemy_side_short) do {
			case "E": {["O_MRAP_02_hmg_F","O_MBT_02_cannon_F", "O_MRAP_02_hmg_F", "O_Truck_03_repair_F", "O_Truck_03_fuel_F", "O_Truck_03_ammo_F", "O_MBT_02_cannon_F"]};
			case "W": {["B_MRAP_01_hmg_F","B_APC_Wheeled_01_cannon_F", "B_MRAP_01_gmg_F", "B_Truck_01_Repair_F", "B_Truck_01_fuel_F", "B_Truck_01_ammo_F", "B_APC_Wheeled_01_cannon_F"]};
			case "G": {["I_MRAP_03_hmg_F","I_APC_Wheeled_03_cannon_F", "I_MRAP_03_hmg_F", "I_Truck_02_box_F", "I_Truck_02_fuel_F", "I_Truck_02_ammo_F", "I_APC_Wheeled_03_cannon_F"]};
		};
	} else {
		d_sm_convoy_vehicles = switch (d_enemy_side_short) do {
